...
contract PlonkVerifier {
  ...
  uint256 private constant G2_SRS_1_X_0 = 17544069637701067367748641319861071345951208969495236756914701796610768950939;
  uint256 private constant G2_SRS_1_X_1 = 21129568017958553273705619700122988209058632656631833639107757421195250117651;
  uint256 private constant G2_SRS_1_Y_0 = 15132158608058640696631633300346962592434949800956230953672192487554079077457;
  uint256 private constant G2_SRS_1_Y_1 = 5161684463759026087976815678192150658711693970074298589173681117984214683052;
  
  uint256 private constant G1_SRS_X = 1;
  uint256 private constant G1_SRS_Y = 2;

  // ----------------------- vk ---------------------
  uint256 private constant VK_NB_PUBLIC_INPUTS = 12;
  ...
  uint256 private constant VK_QL_COM_X = 18468262953615541958530887548739104592987883553372473552870146779695231910873;
  uint256 private constant VK_QL_COM_Y = 2656522028288836516431473283980238854290206202547531925028511124684490342640;
  uint256 private constant VK_QR_COM_X = 14870093523925353992403525257873987001460502187800859497078086784956990359538;
  uint256 private constant VK_QR_COM_Y = 17942584021870604093026696336760910648778757550545980458064933710305524389298;
  uint256 private constant VK_QM_COM_X = 4326226194804405934402024870401996577675413715920289210657887618834588551045;
  uint256 private constant VK_QM_COM_Y = 17571598568685219280610631995069845229682687670911477275010902838006543733373;
  uint256 private constant VK_QO_COM_X = 21725910609095392191080477624353135575256891244865254292646531539890983596096;
  uint256 private constant VK_QO_COM_Y = 747557317585374084654830897261032196010579739567337094239356699048119574957;
  uint256 private constant VK_QK_COM_X = 12118233476544478151623346297144192829915934969468374582869195980734228879025;
  uint256 private constant VK_QK_COM_Y = 11554370624913974105536849498534689273455431383711916589968564295982680803484;
  
  uint256 private constant VK_S1_COM_X = 15677769565829866604618642545430421639235888229878078198708459011429224221299;
  uint256 private constant VK_S1_COM_Y = 19330642692864396516754376868811778640955481763039591590285803206631533086309;
  
  uint256 private constant VK_S2_COM_X = 19851902595701278232420176159733394590435829580950644714275876043382292277747;
  uint256 private constant VK_S2_COM_Y = 5546430772014129263059012140334306280656647644571418930030620705999764784606;
  
  uint256 private constant VK_S3_COM_X = 17851946694754377101015232139622222616530970218002632460118562076694482766562;
  uint256 private constant VK_S3_COM_Y = 21359352644217512755511408911238670042280180456374603996133402287691763224217;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 10935887139697169475366217802128372497223406671623089468983144648990696314179;
  uint256 private constant VK_QCP_0_Y = 17731776587910033289874246384244480905423360820942795528655816126082172876025;
  
  
  uint256 private constant VK_INDEX_COMMIT_API_0 = 160194;
